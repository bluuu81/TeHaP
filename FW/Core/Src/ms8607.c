...
#define HSENSOR_ADDR										0x40 << 1  //0b1000000
...
#define PSENSOR_ADDR										0x76 << 1 //0b1110110
...
enum ms8607_status psensor_read_temperature( float *);
enum ms8607_status psensor_read_pressure( float *);
...
enum ms8607_status ms8607_read_temperature_pressure( float *t, float *p)
{
	enum ms8607_status status;
...
enum ms8607_status ms8607_read_humidity( float *h)
{
	enum ms8607_status status;
